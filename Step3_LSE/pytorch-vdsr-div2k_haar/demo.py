...
im_gt_ycbcr = imread("Set5/" + opt.image + ".png", mode="YCbCr")
im_b_ycbcr = imread("Set5/"+ opt.image + "_scale_"+ str(opt.scale) + ".png", mode="YCbCr")
...
#imsave ('./woman_vdsr.png', im_h)
#np.save ("woman_vdsr.npy", im_h_y[0,:,:])
